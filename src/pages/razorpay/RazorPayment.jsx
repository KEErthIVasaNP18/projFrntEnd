...
const RazorpayPayment = () => {
  ...
  const sendOtp = async () => {
    try {
      const res = await axios.post('https://full-stack-shoppie-cart-bck.onrender.com/sendOtp', { email });
  ...
  const verifyOtp = async () => {
    try {
      const res = await axios.post('https://full-stack-shoppie-cart-bck.onrender.com/verifyOtp', { email, otp: enteredOtp });
  ...
  const loadRazorpay = async () => {
    ...
    try {
      const { data: order } = await axios.post('https://full-stack-shoppie-cart-bck.onrender.com/create-order', { amount });
      ...
      const options = {
        ...
        handler: async function (response) {
          ...
          try {
            const res = await axios.post('https://full-stack-shoppie-cart-bck.onrender.com/verify-payment', verifyData);
