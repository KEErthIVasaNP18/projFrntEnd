...
function CategoryPost() {
    ...
    useEffect(() => {
        const fetchCategory = async () => {
            const response = await axios.get(`https://full-stack-shoppie-cart-bck.onrender.com/api/categories/${id}`);
            setCategory(response.data);
        };

        const fetchPost = async () => {
            const response = await axios.get(`https://full-stack-shoppie-cart-bck.onrender.com/api/posts/category/${id}`);
